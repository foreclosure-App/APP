...
const TABS = [
  {
    ...
    description:
      '<p>Learn How to Avoid Foreclosure</p>',
  ...
  },
  {
    ...
    description:
      '<p>Learn to Understand Your Finances</p>',
    imageUrl: '/demo-illustration-4.png',
    baseColor: '57,148,224',
    secondColor: '99,172,232',
  },
  {
    title: 'Legal Procedures Explained',
    description:
      '<p>Learn to Legal Procedures Explained</p>',
...
export default function FeaturesGallery() {
  ...
  return (
    <FeaturesGalleryWrapper>
      <Content>
        <OverTitle>about us</OverTitle>
        <SectionTitle>What you will get</SectionTitle>
      </Content>
      <GalleryWrapper>
